...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="content">
                <form role="form" class="form-horizontal style-form"  action="{{ url('/ubah', ($data['id'])) }}" method="post">
                    {{csrf_field()}}
                    <!-- <div> -->
                        <h4 class="title"> Ubah Data Member </h4>
                        <p class="category">Lengkapi Form di bawah ini !</p>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col col-sm-4">
                                ...
                                <input type="text" class="form-control border-input" id="inputName"  autocomplete="off" onkeypress="return hanyaHuruf(event)" name="nama_lkp" maxlength="50" value="{{$data['nama']}}" placeholder="tulis nama lengkap" required>
                            </div>
                            <div class="col col-sm-4">
                                <label for="inputName" class="control-label">Domisili KTP</label>
                                <input type="text" class="form-control border-input" value="{{$data['dom_ktp']}}" id="inputName" name="dom_ktp" maxlength="25" placeholder="tulis domisili ktp" required> 
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col col-sm-4">
                                <label for="inputName" class="control-label">No HPnya</label>
                                <input class="form-control border-input" id="hp" value="{{$data['tlp']}}" name="hp"  required>
                            </div>
                            <div class="col col-sm-4">
                                <label for="inputName" class="control-label">Perusahaan</label>
                                <input type="text" class="form-control border-input" onkeypress="return hanyaHuruf(event)" id="inputName" name="perusahaan" maxlength="25" value="{{$data['nama_perusahaan']}}" placeholder="tulis Perusahaan" required>                       
                            </div>
                            <div class="col col-sm-4">
                      ...
                      <!-- <div class="form-group"> -->
                        <div class="form-group">
                            <div class="col col-sm-4">
                                ...
                                <input type="text" class="form-control border-input" onkeypress="return hanyaHuruf(event)" id="inputName" name="dom_perusahaan" maxlength="25" placeholder="tulis Perusahaan" value="{{$data['domisili_perusahaan']}}" required>                       

                            </div>
                            <div class="col col-sm-4">
                                <label for="inputName" class="control-label">No Rekening</label>
                                <input type="number" class="form-control border-input"  id="inputName" name="rekening" maxlength="25" placeholder="tulis nomor rekening" value="{{$data['rekening']}}">
                            </div>
                            <div class="col col-sm-4">
                    ...
                    <div class="row">
                        <center>
                            ...
                            <button type="submit" class="btn btn-theme05 btn-md" >Ubah</button>
                        </center>
                    </div>
                </form>
                <br>
